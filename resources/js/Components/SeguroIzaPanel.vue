<template>
  <div class="p-6 bg-white rounded-2xl shadow-sm border border-slate-200">
    ...
    <!-- SE O MOTORISTA JÁ TIVER SEGURO -->
    <div v-else-if="seguroStatus?.possui_seguro" class="bg-emerald-50 border border-emerald-200 p-6 rounded-2xl shadow-inner">
    ...
    <!-- SE O MOTORISTA NÃO TIVER SEGURO (MURAL DE VENDAS) -->
    ...
    <!-- Botão Transparência -->
    <div v-if="!seguroStatus?.possui_seguro && !isLoading" class="mt-8 text-center border-t border-slate-100 pt-6">
